...
class Paper:
    ...
    def write_html(self, html):
        ...
        paper_html += (
            '<a href="%s"><img src="teasers/%s"/ border=1 width=210></a></td>\n'
...
def read_papers(csv_file):
    papers = []
    with open(csv_file, "rt", encoding="utf-8") as cfile:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--type", help="type of output file (md or html)", default="html"
    )
    ...
    )  # ./usr/local/google/home/junyanz/Projects/CatPapers/reference.csv'
    # load papers
    papers = read_papers(csv_file=csv_file)
    # sort papers
